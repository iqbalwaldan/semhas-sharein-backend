            ...
            <div class="bg-white px-32 py-32 2xl:py-40">
                ...
                <form method="POST" action="/">
                    ...
                    <div class="w-full flex flex-col mt-6">
                        ...
                        <div class="flex">
                            <x-input type="email" name="email" placeholder="your email" required />
                        </div>
                        <x-input-error :messages="$errors->get('email')" class="mt-2" />
                    </div>
                    <button
                        class="bg-[#2652FF] w-full h-11 2xl:h-[51px] mt-10 rounded-md py-2 px-4 text-base 2xl:text-xl font-semibold text-white">
                        Submit
                    </button>
                </form>
            </div>
